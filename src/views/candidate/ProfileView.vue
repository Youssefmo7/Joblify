    ...
    <div class="profile-page__inner">
          ...
          <div class="avatar-card__body">
            ...
            <div class="avatar-card__stats">
              ...
              <div class="avatar-card__stat">
                ...
                <span class="stat-value">
                  {{ authStore.currentUser?.savedJobs?.length || 0 }}
                </span>
              </div>
              <div class="avatar-card__stat">
      ...
      <main class="profile-main">
          ...
          <form class="profile-form" @submit.prevent="handleSave">
            ...
            <div class="form-group">
              <label class="form-label">
                Avatar URL
                <span class="optional"> (leave blank to use initials) </span>
              </label>
              <input
                v-model="form.avatar"
                class="form-input"
            ...
            <div class="form-footer">
              <div>
                ...
                <p v-if="saveSuccess" class="form-success">Changes saved!</p>
              </div>
              <button
                type="submit"
                class="btn-primary"
        ...
        <div v-if="activeTab === 'skills'" class="profile-card">
          <div class="profile-card__header">
            <h2 class="profile-card__title">Skills & technologies</h2>
            <p class="profile-card__sub">
          ...
          <div class="skill-add-row">
            ...
            />
            <button type="button" class="btn-secondary" @click="addSkill">
              Add
            </button>
          </div>
          ...
          <div v-if="form.skills.length" class="skills-grid">
            ...
            >
              <span>{{ skill }}</span>
              <button class="skill-pill__remove" @click="removeSkill(i)">
                ✕
              </button>
            </div>
          </div>
          ...
          <div class="form-footer">
            <p v-if="saveSuccess" class="form-success">Skills saved!</p>
            <button
              class="btn-primary"
              :disabled="authStore.loading"
              @click="handleSave"
        ...
        <div v-if="activeTab === 'resume'" class="profile-card">
          ...
          <div v-if="form.resumeUrl" class="resume-current">
            ...
            <div class="resume-current__actions">
              <a :href="form.resumeUrl" target="_blank" class="btn-ghost-sm">
                View
              </a>
          ...
          <div class="form-footer">
            <div>
              <p v-if="saveSuccess" class="form-success">Resume saved!</p>
              <p v-if="authStore.error" class="form-error">
                {{ authStore.error }}
              </p>
            </div>
        ...
        <div v-if="activeTab === 'account'" class="profile-card">
          ...
          <form class="profile-form" @submit.prevent="handlePasswordChange">
            ...
            <p v-if="passwordSuccess" class="form-success">Password updated!</p>
