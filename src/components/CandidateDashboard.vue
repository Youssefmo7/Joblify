      ...
      <aside class="w-64 hidden md:block flex-shrink-0">
        ...
        >
          ...
          <nav class="p-2 space-y-1">
            ...
            >
              <span class="h-5 w-5 mr-3 flex-shrink-0" v-html="item.icon" />
              {{ item.label }}
              <span
                v-if="item.badge"
      ...
      <div class="flex-1 min-w-0 space-y-6">
        ...
        <template v-if="activeSection === 'overview'">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-white rounded-xl border border-[#e8ecf1] p-5">
            ...
            <div class="flex items-start justify-between">
              <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                  Add your resume and skills to boost your ranking.
                </p>
              </div>
...
export default {
  ...
  computed: {
    navItems() {
      return [
        { key: "overview", label: "Overview", icon: NAV_ICONS.overview },
        { key: "profile", label: "Profile Settings", icon: NAV_ICONS.profile },
        {
          key: "applications",
  ...
  methods: {
    ...
    badgeLabel(status) {
      return (
        { pending: "In Review", accepted: "Accepted", rejected: "Rejected" }[
          status
        ] ?? status
      );
    },
